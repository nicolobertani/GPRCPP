...
Rcpp::sourceCpp("SVI/rcpp_step_k_se_svi.cpp")


# Hensman - Per+ -----------------------------------------------------------

Rcpp::sourceCpp("SVI/rcpp_step_k_per_svi.cpp")


# Hensman - Lin+ -----------------------------------------------------------

Rcpp::sourceCpp("SVI/rcpp_step_k_lin_svi.cpp")


# Hensman - SExSE ------------------------------------------------------------

Rcpp::sourceCpp("SVI/rcpp_step_k_sese_svi.cpp")


# Hensman - PerxSE --------------------------------------------------------

Rcpp::sourceCpp("SVI/rcpp_step_k_perse_svi.cpp")


# Hensman - LinxSE -----------------------------------------------------------

Rcpp::sourceCpp("SVI/rcpp_step_k_linse_svi.cpp")
