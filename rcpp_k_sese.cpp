...
// [[Rcpp::export]]
mat rcpp_k_sese(const mat &M, const mat &N, const mat &P, const mat &Q, const double l, const double s, const double m, const bool equal_matrices) {
  mat K_se_1, K_se_2, res;
  K_se_1 = rcpp_k_se(M, N, l, s, equal_matrices);
  K_se_2 = rcpp_k_se(P, Q, m, 1, equal_matrices);
  res = K_se_1 % K_se_2;
  return res;
}
